-- Migration: Revert leaderboard function to basic version
-- Description: Remove win rate and profit factor from the leaderboard function

-- Record the migration
INSERT INTO migration_log (migration_name, description, executed_at)
VALUES ('20240716000000_revert_leaderboard_to_basic', 'Revert leaderboard function to basic version without win rate and profit factor', NOW());

-- Drop the existing function
DROP FUNCTION IF EXISTS public.get_monthly_leaderboard();

-- Create updated function to use username but without win rate and profit factor
