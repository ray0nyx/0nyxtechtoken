-- Case sensitivity fix for TopstepX function
DO $$
BEGIN
  RAISE NOTICE 'Starting TopstepX function case sensitivity fix...';
    ...
    FOR i IN 0..v_total_rows - 1 LOOP
      ...
      BEGIN
        ...
        INSERT INTO trades (
          ...
          "buyFillId",     -- These fields need to be quoted with proper case
          "sellFillId",
          "buyPrice",
          "sellPrice",
          "boughtTimestamp",
