-- Fix the RAISE WARNING syntax in the clean_dollar_amount function
-- PostgreSQL uses % for format specifiers, not %%

-- Recreate the clean_dollar_amount function with correct RAISE syntax
...
BEGIN
    ...
    EXCEPTION WHEN OTHERS THEN
        -- Fixed: Using single % instead of %% for format specifier
