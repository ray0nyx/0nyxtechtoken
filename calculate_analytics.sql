-- Script to calculate analytics metrics from trades and insert into analytics table
-- This script calculates the following metrics for each user:
-- - Total Trades
-- - Win Rate
-- - Total P&L
-- - Average P&L
...
DECLARE
    user_rec RECORD;
BEGIN
    FOR user_rec IN SELECT DISTINCT user_id FROM trades LOOP
...
SELECT calculate_all_users_analytics(); 