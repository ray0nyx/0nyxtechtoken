-- Fix the column names in process_tradovate_csv_row function
-- First, use a dynamic approach to identify and drop ALL versions of process_tradovate_csv_row
DO $$
DECLARE
    func record;
BEGIN
...
-- Create a single correct version of the function with corrected column names
...
-- Also fix the process_tradovate_csv_batch function to use the corrected function
