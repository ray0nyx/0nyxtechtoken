-- Ensure all users have default accounts
-- Create the function to create default accounts if it doesn't exist
...
-- Create a trigger function to automatically create default accounts for new users
...
FOR EACH ROW
EXECUTE FUNCTION create_default_accounts_for_new_user();

-- Fix the process_tradovate_csv_batch function to handle hardcoded account IDs
DO $$
DECLARE
    func record;
BEGIN
