/**
 * Fallback Python Code Editor Component
 * Simple textarea with Python syntax highlighting using CSS
 */
...
interface FallbackPythonEditorProps {
  value: string;
...
export function FallbackPythonEditor({ 
  value, 
  onChange, 
  onCompile, 
  onRun, 
