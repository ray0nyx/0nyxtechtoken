-- Migration: integrate_dollar_sign_cleaning
-- Description: Integrates the clean_dollar_sign function into CSV processing

-- Record the migration
INSERT INTO migration_log (migration_name, description, executed_at)
VALUES ('20240715000007_integrate_dollar_sign_cleaning', 'Integrates the clean_dollar_sign function into CSV processing', NOW());
...
-- Update the process_tradovate_csv_row function to use clean_dollar_sign
...
BEGIN
    ...
    v_cleaned_entry_price := clean_dollar_sign(p_entry_price::TEXT);
    v_cleaned_exit_price := clean_dollar_sign(p_exit_price::TEXT);
    v_cleaned_commission := clean_dollar_sign(p_commission::TEXT);
...
-- Update the process_tradovate_csv_batch function to handle dollar signs
