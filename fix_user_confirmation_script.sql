...
-- This migration addresses the error with confirmed_at column being a generated column
...
-- Update the trigger function to be more robust and avoid confirmed_at issues
