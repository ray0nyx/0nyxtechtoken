 ...
 * Uses Monaco Editor (VSCode editor) with Python language support
 * Integrates with the backtester for strategy code compilation
 */
...
export function PythonCodeEditor({ 
    ...
    const initEditor = async () => {
      try {
        ...
        if (editorRef.current && !editorInstanceRef.current) {
          ...
          editorInstance.addCommand(monacoInstance.KeyMod.CtrlCmd | monacoInstance.KeyMod.Shift | monacoInstance.KeyCode.KeyC, () => {
            handleCompile();
          });

          editorInstance.addCommand(monacoInstance.KeyMod.CtrlCmd | monacoInstance.KeyMod.Shift | monacoInstance.KeyCode.KeyR, () => {
            handleRun();
          });
  ...
  useEffect(() => {
    if (editorInstanceRef.current && isEditorReady && editorInstanceRef.current.getValue() !== value) {
